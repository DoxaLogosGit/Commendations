OpenXcom Commendations Mod v 3.1
--------------------------------
...
- Meridian: many palette fixes on the images
...
#### CHANGELOG:
 - *3.1*: Fix metadata.yml and install file references.  Many palette fixes by Meridian.
